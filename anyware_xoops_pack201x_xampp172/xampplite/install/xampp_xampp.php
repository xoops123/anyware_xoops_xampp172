...
class XAMPP
{
    protected static $xampppath     = 'C:\xampplite';
    protected static $installerpath = 'C:\xampplite\install';
    protected static $locationfile  = 'C:\xampplite\install\xampp_location.txt';
    protected static $versionfile   = 'C:\xampplite\install\xampp_version.txt';
    protected static $modellfile    = 'C:\xampplite\install\xampp_modell.txt';
    protected static $xamppversion  = '';
    protected static $xamppmodell   = 'XAMPP Lite';
