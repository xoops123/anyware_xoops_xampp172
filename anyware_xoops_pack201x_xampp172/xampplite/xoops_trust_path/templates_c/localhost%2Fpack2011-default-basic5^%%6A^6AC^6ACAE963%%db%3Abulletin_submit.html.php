<?php /* Smarty version 2.6.26, created on 2012-01-02 18:48:32
         ...
         <?php if ($this->_tpl_vars['use_fckeditor'] && ! $this->_tpl_vars['common_fck_installed']): ?>
             <?php if ($this->_tpl_vars['html'] == '1'): ?>
                   <?php if ($this->_tpl_vars['xcode'] == '1' || $this->_tpl_vars['br'] == '1' || $this->_tpl_vars['smiley'] == '1'): ?>
                        <?php echo smarty_function_xoops_dhtmltarea(array('cols' => $this->_tpl_vars['bulletin_post_tray_col'],'rows' => $this->_tpl_vars['bulletin_post_tray_row'],'name' => 'body','id' => 'body','value' => ($this->_tpl_vars['text_raw']),'myckeditor' => true,'editor' => 'bbcode'), $this);?>

                   <?php else: ?>
                        <?php echo smarty_function_xoops_dhtmltarea(array('cols' => $this->_tpl_vars['bulletin_post_tray_col'],'rows' => $this->_tpl_vars['bulletin_post_tray_row'],'name' => 'body','id' => 'body','value' => ($this->_tpl_vars['text_raw']),'myckeditor' => true,'editor' => 'html'), $this);?>
