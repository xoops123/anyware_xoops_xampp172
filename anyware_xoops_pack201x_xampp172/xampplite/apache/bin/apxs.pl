...
my $installbuilddir = '\xampplite\apache\build';
...
my $CP    = '\xampplite\perl\bin\perl.exe -MExtUtils::Command -e cp';
my $CHMOD = '\xampplite\perl\bin\perl.exe -MExtUtils::Command -e chmod';
my $RM_F  = '\xampplite\perl\bin\perl.exe -MExtUtils::Command -e rm_f';
my $TOUCH = '\xampplite\perl\bin\perl.exe -MExtUtils::Command -e touch';
